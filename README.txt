...
= 1.3 =
* Added translation support to previously static strings.
* Updated code to current best practices.
* Updated copyright info.
* Updated ReadMe and added a ChangeLog.

= 1.2 =
* Added AKLH_LOADED check.
* Added install function.
* Removed some old code that relied on the Prototype library.
* More general code cleanup and optimizations.
* Bumped ReadMe version.

= 1.1 =
* Updated translation text domain.
* Added debug code and logging functionality.
* Updated table prefix codes.
* Added excluded file extensions functionality.
